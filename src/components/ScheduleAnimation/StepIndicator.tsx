      ...
      <div className="space-y-8">
        {steps.map((step, index) => {
          ...
          return (
            ...
            >
              {/* Step icon */}
              <div className={`w-16 h-16 rounded-3xl flex items-center justify-center transition-all duration-300 glass-card ${
                isActive
                  ? 'ring-2 ring-stellar-accent glow-effect'
                  : isCompleted
                  ? 'ring-1 ring-stellar-accent/50'
                  : ''
              }`}>
